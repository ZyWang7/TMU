...
if __name__ == '__main__':
    ...
    parser.add_argument('--version', type=str, choices=['v2', 'v3'],
                        help='HO3D version', default='v3')
    parser.add_argument('--r', type=int, default=0, help='Number of tokens merged per layer.')
    args = parser.parse_args()

    gt_path = "evaluation/HO3D/gt"
    pred_path = "results"
    # output_dir = "evaluation/HO3D/eval_results/r" + str(args.r)
    output_dir = "evaluation/HO3D/eval_results/ori_Hamer"
    version = args.version
    pred_file_name = "HO3D_r" + str(args.r) + ".json"
    pred_file_name = "ho3d_origin.json"
    set_name='evaluation'
    os.makedirs(output_dir, exist_ok=True)

    main(gt_path, pred_path, output_dir, version, pred_file_name, set_name)
